...
if [ -z "$1" ]; then
    ...
    echo ""
    echo "Usage: ./systems/context-automation/prompt_checklist.sh <change_type>"
    echo "Example: ./systems/context-automation/prompt_checklist.sh client_won"
    exit 1
fi

python3 systems/context-automation/context_manager.py prompt "$1"
