# MASTER RULES FOR BRANDED + FLOW — REFERENCE ONLY
...
**This section provides context and examples. For enforcement, see `.cursorrules` and `systems/doe-engine/ACTIVE_DIRECTIVE.md`**
...
## 🎯 DOE METHOD - WORKFLOW PATTERNS (REFERENCE)
...
**Pattern:** Only 6 root folders exist. Use lowercase-kebab-case for all names.
